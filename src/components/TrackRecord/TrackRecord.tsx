            ...
            <MotionTransition>
                <div className="grid max-w-7xl mx-auto md:grid-cols-1">
                    <div>
                        ...
                        <h4 className="text-xl mb-3">Trusted by thousands of creators and professionals worldwide</h4>
                        <Reveal>
                            <p className="w-full md:w-4/5 mt-10 text-lg font-normal font-montserrat">Explore our track record of outstanding achievements and discover how we've driven our clients' success through innovative strategies and tangible results.</p>
                        </Reveal>
                    </div>
                </div>
            </MotionTransition>
